<template>
  <div id="detailConrainer" class="slide-enter-active">
    <Header title="影片详情">
      <i class="iconfont icon-right" @touchstart="handleToBack"></i>  <!-- 放到slot中 -->
    </Header>
...
#content .detail_player{ margin:0}
.detail_player .swiper-slide{ width:40px; margin-right: 20px; text-align: center; font-size: 14px;}
.detail_player .swiper-slide img{ width:40%; margin-bottom: 5px; margin: 0 auto;}
